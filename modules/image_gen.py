...
class ImageGenerator:
    def __init__(self, width: int, height: int, background: float | tuple[float, ...] | str | None):
        ...
        try:
            self._tall_digits_img = Image.open("assets/tall-digits.png")
            self._min_img = Image.open("assets/min.png")
            self._unifont_img = Image.open("assets/unifont-16.0.04.bmp")
            self._small_digits_img = Image.open("assets/small-digits.png")
            self._plus_img = Image.open("assets/plus.png")
